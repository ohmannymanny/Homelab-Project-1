...
## Homelab Project 1 – README

This repository tracks the design, build, and evolution of my personal cybersecurity homelab.

It is tightly linked to my Obsidian vault and is intended to serve as:

- A learning log
- A technical portfolio
- A reference for future projects
- Evidence of hands-on experience for cybersecurity roles
